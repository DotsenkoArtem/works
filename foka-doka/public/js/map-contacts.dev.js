...
function diagram(props) {
  ...
  var gradient = [];
  var previous = 0;
  for (var i = 0; i < props.colors.length; i += 1) {
    var p = props.colors[i];
    var deg = 360 / 100 * p.percentage;
    gradient.push("".concat(p.color, " ").concat(previous, "deg ").concat(previous + deg, "deg"));
...
function icon(props) {
  ...
  circle.style.color = props.color;
  circle.style.backgroundImage = "url(".concat(props.icon, ")");
